  ...
  return (
    <footer className="bg-[#0C1618] border-t border-[#58C1C3]/15 pt-16 pb-12 px-4 sm:px-6 lg:px-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 pb-14 border-b border-white/5">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="inline-block pt-1">
              <span className="text-xs font-mono text-[#97CC6F] bg-[#97CC6F]/10 px-3 py-1 rounded-full border border-[#97CC6F]/20">
            ...
            {/* Social Media Icons */}
            <div className="pt-2">
              <p className="text-[10px] uppercase font-mono tracking-widest text-[#F5F7F7]/40 mb-3">
                Connect With Us
              </p>
              <div className="flex items-center gap-2.5">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="w-8 h-8 rounded-lg bg-[#0F1E22] border border-[#58C1C3]/20 hover:border-[#58C1C3] text-[#F5F7F7]/70 hover:text-[#58C1C3] flex items-center justify-center transition-all hover:scale-105"
                  >
                    {social.icon}
                  </a>
                ))}
          ...
          <div className="lg:col-span-2">
            <h4 className="text-xs font-bold uppercase tracking-wider text-[#58C1C3] mb-4">
              Navigation
            </h4>
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <div className="text-xs text-[#F5F7F7]/70 space-y-2.5">
              ...
              <div className="flex items-center gap-2">
                <MapPin className="w-3.5 h-3.5 text-[#58C1C3] flex-shrink-0" />
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 hover:text-[#58C1C3] transition-colors font-mono text-[#58C1C3]"
              >
                <Globe className="w-3.5 h-3.5 text-[#58C1C3] flex-shrink-0" />
        ...
        {/* Bottom Bar */}
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#F5F7F7]/40">
          <div>
            © {new Date().getFullYear()} <span className="text-[#58C1C3]">PLEXIVIA</span>. All rights reserved. Crafting Digital Dreams.
          </div>

          <div className="flex items-center gap-6">
            <span className="font-mono text-[11px] text-[#97CC6F]">
              Dhaka, Bangladesh • Worldwide
            </span>
            <button
              onClick={scrollToTop}
              className="w-8 h-8 rounded-full bg-[#0F1E22] border border-white/10 hover:border-[#58C1C3] text-white/60 hover:text-white flex items-center justify-center transition-colors cursor-pointer"
